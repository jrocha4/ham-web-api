  ...
  .directive('successMessageBox', [
    function() {
      ...
      return {
        ...
        replace: true,
        template: '<div id="message-box-slot" ng-show="msg">'+
  ...
  .directive('errorMessageBox', [
    function() {
      ...
      return {
        ...
        template: '<div class="alert alert-danger text-center" role="alert" ng-show="validationErrors.length" style="margin-bottom: -20px">'+
